...
import { D as Dialog, d as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-D9SBQmWA.mjs";
import { f as adminListListings, g as adminModerateListing } from "./admin.functions-ByUlPAk_.mjs";
import { t as timeAgo, f as formatINR } from "./format-CVlb_WBO.mjs";
import "../_libs/seroval.mjs";
import { S as Search, t as User, d as Mail, e as MapPin, h as Calendar, E as Eye, u as CircleCheck, T as Trash2 } from "../_libs/lucide-react.mjs";
...
function RejectedListingsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Rejected Listings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Listings that were not approved. You can re-approve or delete them." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Search rejected…", className: "pl-9" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-3", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading…" }) : listings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-8 text-center text-sm text-muted-foreground", children: "No rejected listings." }) : listings.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mt-1 bg-rose-500/15 text-rose-700 dark:text-rose-400", variant: "secondary", children: "Rejected" })
          ] })
        ] }),
        l.rejection_reason && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 rounded-md bg-rose-500/5 px-2 py-1 text-xs text-rose-700 dark:text-rose-400", children: [
          "Reason: ",
          l.rejection_reason
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "bg-emerald-600 text-white hover:bg-emerald-700", onClick: () => moderate(l.id, "approve"), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "ghost", className: "text-destructive", onClick: () => {
            if (confirm("Delete permanently?")) moderate(l.id, "delete");
          }, children: [
...
export {
  RejectedListingsPage as component
};
