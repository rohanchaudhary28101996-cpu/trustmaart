...
import { D as Dialog, d as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, e as DialogFooter, f as DialogDescription } from "./dialog-D9SBQmWA.mjs";
...
import { S as Search, t as User, d as Mail, P as Phone, e as MapPin, h as Calendar, E as Eye, u as CircleCheck, v as Circle, Y as TriangleAlert, a0 as CirclePause, T as Trash2 } from "../_libs/lucide-react.mjs";
...
function PendingAdsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Pending Approval" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Review and verify ads before they go live." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Search pending ads…", className: "pl-9" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-3", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading…" }) : listings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-8 text-center text-sm text-muted-foreground", children: "No pending ads. Great job!" }) : listings.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(PendingAdCard, { l, onAction: moderate }, l.id)) })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex flex-wrap gap-3 text-xs text-muted-foreground", children: [
            ...
            l.seller_phone && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "capitalize", children: l.type })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ReasonDialog, { open: openDialog === "request_changes", setOpen: (o) => setOpenDialog(o ? "request_changes" : null), title: "Request Changes", desc: "List what needs to be fixed.", label: "Request Changes", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "mr-1 h-3 w-3" }), variant: "outline", reason, setReason, onSubmit: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "ghost", className: "text-destructive", onClick: () => {
          if (confirm("Delete this listing permanently?")) onAction(l.id, "delete");
        }, children: [
