...
import { T as TSS_SERVER_FUNCTION, g as getServerFnById, c as createServerFn } from "./server-D1062Wfa.mjs";
...
const $$splitErrorComponentImporter$1 = () => import("./search-DxvMjsv1.mjs");
const $$splitComponentImporter$t = () => import("./search-jdJWn7gS.mjs");
...
const $$splitComponentImporter$s = () => import("./help-DkvylHY6.mjs");
...
const $$splitComponentImporter$r = () => import("./contact-C5omT9ww.mjs");
...
const $$splitComponentImporter$q = () => import("./browse-pLOdoIyd.mjs");
...
const $$splitComponentImporter$p = () => import("./auth-ebg9s1rX.mjs");
...
const $$splitComponentImporter$o = () => import("./about-CwsnqYU1.mjs");
...
const $$splitComponentImporter$n = () => import("./route-DPyoKYdl.mjs");
...
const $$splitComponentImporter$l = () => import("./index-Bh1B6PBH.mjs");
...
const $$splitComponentImporter$k = () => import("./listing._id-BYdun-ut.mjs");
const $$splitNotFoundComponentImporter = () => import("./listing._id-CDcGntON.mjs");
...
const $$splitComponentImporter$j = () => import("./auth.reset-password-BKfx7or5.mjs");
...
const $$splitComponentImporter$i = () => import("./users-BVnmZlyh.mjs");
const Route$i = createFileRoute("/admin/users")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./settings-LFG4MTvM.mjs");
const Route$h = createFileRoute("/admin/settings")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./reported-listings-Drqws05H.mjs");
const Route$g = createFileRoute("/admin/reported-listings")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./rejected-listings-QAhQuLnl.mjs");
const Route$f = createFileRoute("/admin/rejected-listings")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./pending-ads-DEtwE19E.mjs");
const Route$e = createFileRoute("/admin/pending-ads")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./notifications-2DPkSk3W.mjs");
const Route$d = createFileRoute("/admin/notifications")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./login-DL6Q2gz5.mjs");
...
const $$splitComponentImporter$b = () => import("./live-listings-Ck8K3bjZ.mjs");
const Route$b = createFileRoute("/admin/live-listings")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./dashboard-CFWbD6o8.mjs");
const Route$a = createFileRoute("/admin/dashboard")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./chat-monitoring-Dc1vq5WP.mjs");
const Route$9 = createFileRoute("/admin/chat-monitoring")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./action-logs-yIAg9-aS.mjs");
const Route$8 = createFileRoute("/admin/action-logs")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./wishlist-BG1JAKHL.mjs");
const Route$7 = createFileRoute("/_authenticated/wishlist")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./sell-DoBEcbGP.mjs");
const Route$6 = createFileRoute("/_authenticated/sell")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./profile-C4QkAGea.mjs");
const Route$5 = createFileRoute("/_authenticated/profile")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./notifications--6hRgfED.mjs");
const Route$4 = createFileRoute("/_authenticated/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-CPqaz_V1.mjs");
const Route$3 = createFileRoute("/_authenticated/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./chat-Ckc0wYUj.mjs");
const Route$2 = createFileRoute("/_authenticated/chat")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_type-BepS84rg.mjs");
const Route$1 = createFileRoute("/admin/listings/$type")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./chat._id-QK82wtjw.mjs");
